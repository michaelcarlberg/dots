...
theme.set_highlights = function()
  ...
  hl(0, "CursorLine", { fg = 'NONE', bg = '#2b2d4a' })
  hl(0, "CursorLineNr", { fg = 'NONE', bg = '#2b2d4a' })
  hl(0, "CursorLineSign", { fg = 'NONE', bg = '#2b2d4a' })
  hl(0, "Folded", { fg = c.muted, bg = 'NONE' })
  hl(0, "FoldColumn", { fg = c.muted, bg = 'NONE' })
  hl(0, "LineNr", { fg = '#2a2c4a', bg = '#161822' })
  hl(0, "FloatBorder", { fg = c.muted, bg = 'NONE' })
  hl(0, "Whitespace", { fg = c.muted, bg = 'NONE' })
  hl(0, "VertSplit", { fg = c.muted, bg = 'NONE' })
  ...
  hl(0, "WarningMsg", { fg = c.brightred, bg = 'NONE' })
  hl(0, "DiffText", { fg = c.black, bg = c.red })
  hl(0, "DiffAdd", { fg = c.black, bg = c.green })
  hl(0, "DiffChange", { fg = c.black, bg = c.cyan, underline=true, })
  ...
  hl(0, "Cursor", { fg = c.red, bg = c.muted })
  hl(0, "lCursor", { fg = c.red, bg = c.muted })
  hl(0, "CursorIM", { fg = c.red, bg = c.muted })
  hl(0, "TermCursor", { fg = c.red, bg = c.muted })
  hl(0, "TermCursorNC", { fg = c.red, bg = c.muted })
  hl(0, "Conceal", { fg = c.muted, bg = 'NONE' })
  ...
  hl(0, "TabLineFill", { fg = c.black, bg = 'NONE' })
  ...
  hl(0, "TelescopeBorder", { fg = c.muted, bg = 'NONE' })
  hl(0, "TelescopePathSeparator", { fg = c.white, bg = 'NONE', bold=true, })
  ...
  hl(0, "TelescopeTitle", { fg = c.red, bg = 'NONE' })

  -- NvimTree
  hl(0, "NvimTreeFolderIcon", { fg = c.muted, bg = 'NONE' })
  hl(0, "NvimTreeIndentMarker", { fg = c.muted, bg = 'NONE' })
  hl(0, "NvimTreeNormal", { fg = c.white, bg = 'NONE' })
  hl(0, "NvimTreeVertSplit", { fg = c.black, bg = 'NONE' })
  hl(0, "NvimTreeFolderName", { fg = c.fg, bg = 'NONE', bold=true, })
  ...
  hl(0, "NvimTreeCursorLine", { fg = 'NONE', bg = '#2b2d4a' })
  ...
  hl(0, "NvimTreeWindowPicker", { fg = c.brightred, bg = c.black, bold=true, })

  -- NeoTree
  hl(0, "NeoTreeFolderIcon", { fg = c.fg, bg = 'NONE' })
  hl(0, "NeoTreeIndentMarker", { fg = c.gray, bg = 'NONE' })
  hl(0, "NeoTreeNormal", { fg = c.white, bg = 'NONE' })
  hl(0, "NeoTreeVertSplit", { fg = c.black, bg = 'NONE' })
  hl(0, "NeoTreeWinSeparator", { fg = '#2b2d4a', bg = 'NONE' })
  ...
  -- StatusLine
  hl(0, "StatusLine", { fg = c.light_gray, bg = 'NONE' })
  hl(0, "StatusLineNC", { fg = c.black, bg = 'NONE' })
  ...
  -- Dressing
  hl(0, "DressingNormal", { fg = '#d5d8da', bg = '#1c1e26' })
  hl(0, "DressingCursorLine", { fg = '#f5a541', bg = '#262830' })
  hl(0, "DressingFloatBorder", { fg = '#3f414f', bg = 'NONE' })
  hl(0, "DressingFloatTitle", { fg = '#9e9e9e', bg = 'NONE' })
  hl(0, "DressingFloatTitleAlt", { fg = '#f5a541', bg = 'NONE' })
end
